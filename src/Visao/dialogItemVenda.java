 ...
 * @author Aluno
 */
public class dialogItemVenda extends javax.swing.JDialog {
    Produto prod;
    EntityManagerFactory emf = Persistence.createEntityManagerFactory("Luan_ProjetoPU");
    ControlaProduto controle = new ControlaProduto(emf);
    /**
     * Creates new form dialogItemVenda
     */
    public dialogItemVenda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, produtoList, tabProduto);
        ...
        jTableBinding.bind();
        tabProdutos.setViewportView(tabProduto);
    ...
    private void botSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botSelecionarActionPerformed
       if(tabProduto.getSelectedRow() == -1){
          ...
          prod = produtoList.get(tabProduto.getSelectedRow());
         this.dispose();
       }
    ...
    private void botLocalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botLocalizarActionPerformed
        produtoList.clear();
        produtoList.addAll(controle.schDescricao(txtProduto.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogItemVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogItemVenda dialog = new dialogItemVenda(new javax.swing.JFrame(), true);
